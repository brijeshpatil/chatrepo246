<%@ Page Title="" Language="C#" MasterPageFile="~/Common.Master" AutoEventWireup="true"
    CodeBehind="Login.aspx.cs" Inherits="ChatRoom.WebForm2" %>
        ...
        <div class="middle-login">
            <div class="block-flat">
                ...
                <div style="margin-bottom: 0px !important;" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <div class="input-group">
                                    ...
                                    <asp:TextBox ID="TextBox1" runat="server" class="form-control" required placeholder="User Name"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="foot">
                        <asp:Button ID="Button2" runat="server" Text="Log me in" class="btn btn-primary"
                            data-dismiss="modal" OnClick="Button2_Click" />
                        <asp:HyperLink ID="HyperLink1" runat="server" class="btn btn-default" NavigateUrl="~/Signup.aspx">Register</asp:HyperLink>
                    </div>
                </div>
            </div>
